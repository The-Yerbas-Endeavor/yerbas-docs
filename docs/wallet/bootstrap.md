  ...
  <div className="container padding--sm">
    ...
    <div className="row padding--sm">
      ...
      <div className="col col--6">
        <a
          ...
          href="https://github.com/The-Yerbas-Endeavor/yerbas/releases/download/3.1.2.7/powcache.dat"
          download
        >
          💾 POW Cache (.dat)
        </a>
    ...
    <div className="row padding--sm">
      ...
      <div className="col col--6">
        <a
          class="button button--primary"
          href="https://github.com/The-Yerbas-Endeavor/yerbas/releases/download/3.1.2.7/bootstrap.zip"
          download
        >
