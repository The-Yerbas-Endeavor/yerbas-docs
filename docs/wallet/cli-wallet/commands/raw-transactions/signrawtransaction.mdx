...
<ReactPlayer
  ...
  url={[
    {
      src: `${require('./assets/signrawtransaction.webm').default}`,
      type: 'video/webm',
    },
  ]}
/>
...
```bash
curl --user myusername --data-binary '{"jsonrpc": "1.0", "id":"curltest", "method": "signrawtransaction", "params": ["myhex"] }' -H 'content-type: text/plain;' http://127.0.0.1:9998/
```
