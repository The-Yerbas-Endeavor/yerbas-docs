...
- Download bootstrap.zip listed on our latest release: <https://github.com/The-Yerbas-Endeavor/yerbas/releases/>
- Unzip the bootstrap and copy the folders into Yerbascore data directory.
- Start the wallet.
...
1. Download: (Yerbas bootstrap packages)[https://bootstrap.yerbas.org/]
