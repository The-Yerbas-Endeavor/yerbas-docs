...
Download the latest Yerbas wallet from https://github.com/the-yerbas-endeavor/yerbas/releases. I recommend getting the windows zip file and not the setup.exe as the steps shown below will use that file
