...
<table>
  ...
  <tr>
    ...
    <h3>How many days is 1,000,000 blocks?</h3>
    <p>1,000,000 blocks = 1,388.88 days @ 2 minute blocks</p>
    <h3>What is that in years?</h3>
    <p>1,388.88 / 365.25 = 3.80 years (with one leap year)</p>
    <h3>How accurate are those timelines</h3>
