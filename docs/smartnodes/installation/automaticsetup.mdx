...
```bash
bash <(curl -s https://raw.githubusercontent.com/dk808/Yerbas_Smartnode/main/install.sh)
```
...
Script source: [dk808/Yerbas_SmartNode][dk808]
...
[dk808]: https://github.com/dk808/Yerbas_SmartNode
