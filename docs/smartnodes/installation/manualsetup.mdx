...
```bash
wget https://github.com/The-Yerbas-Endeavor/yerbas/releases/download/3.1.2.7/yerbas-ubuntu20-v3.1.2.7.tar.gz
tar -xvf yerbas-ubuntu20-v3.1.2.7.tar.gz
mkdir ~/.yerbascore && touch ~/.yerbascore/yerbas.conf
echo "daemon=1" >> ~/.yerbascore/yerbas.conf
cd .yerbascore
wget https://github.com/The-Yerbas-Endeavor/yerbas/releases/download/3.1.2.7/powcache.dat
cd ~/yerbas-build
./yerbasd
```
