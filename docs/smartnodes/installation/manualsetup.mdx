...
mkdir -p rtm_latest
cd rtm_latest
wget https://github.com/The-Yerbas-Endeavor/yerbas/releases/download/3.2.0.14/yerbas-ubuntu26-3.2.0.14.tar.gz
tar -xvf yerbas-ubuntu26-3.2.0.14.tar.gz
cd ..
wget https://bootstrap.yerbas.com/bootstraps_for_v3.2.0.14/bootstrap.zip
unzip bootstrap.zip
