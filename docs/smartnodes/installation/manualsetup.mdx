...
```bash
wget https://github.com/The-Yerbas-Endeavor/yerbas/releases/download/v3.2.0.14/yerbas-ubuntu26-v3.2.0.14.tar.gz
tar -xvf yerbas-ubuntu20-v3.2.0.14.tar.gz
mkdir ~/.yerbascore && touch ~/.yerbascore/yerbas.conf
echo "daemon=1" >> ~/.yerbascore/yerbas.conf
cd .yerbascore
wget https://github.com/The-Yerbas-Endeavor/yerbas/releases/download/v3.2.0.14/powcache.dat
cd ~/yerbas-build
./yerbasd
```
