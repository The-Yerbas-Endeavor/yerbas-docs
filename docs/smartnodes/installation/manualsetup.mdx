...
```bash
wget https://github.com/The-Yerbas-Endeavor/yerbas/releases/download/v3.1.2.8/yerbas-ubuntu20-v3.1.2.8.tar.gz
tar -xvf yerbas-ubuntu20-v3.1.2.8.tar.gz
mkdir ~/.yerbascore && touch ~/.yerbascore/yerbas.conf
echo "daemon=1" >> ~/.yerbascore/yerbas.conf
cd .yerbascore
wget https://github.com/The-Yerbas-Endeavor/yerbas/releases/download/v3.1.2.8/powcache.dat
cd ~/yerbas-build
./yerbasd
```
